...
INSERT INTO MEMBER (`id`, `email`, `password`, `name`, `asset`, `department_id`, `deleted`) values ('1', 'admin', '$2a$10$qfKy2Md2U8ThUV0w/Om86uQBcvzqog3QAbCt0uhDpJ0olvPKXxn/C', '관리자', 0, '0', false);
INSERT INTO MEMBER (`id`, `email`, `password`, `name`, `asset`, `department_id`, `deleted`) values ('2', 'youth', '$2a$10$qfKy2Md2U8ThUV0w/Om86uQBcvzqog3QAbCt0uhDpJ0olvPKXxn/C', '청년부', 0, '1', false);
INSERT INTO MEMBER (`id`, `email`, `password`, `name`, `asset`, `department_id`, `deleted`) values ('3', 'secondary', '$2a$10$qfKy2Md2U8ThUV0w/Om86uQBcvzqog3QAbCt0uhDpJ0olvPKXxn/C', '중고등부', 0, '2', false);
INSERT INTO MEMBER (`id`, `email`, `password`, `name`, `asset`, `department_id`, `deleted`) values ('4', 'elementary', '$2a$10$qfKy2Md2U8ThUV0w/Om86uQBcvzqog3QAbCt0uhDpJ0olvPKXxn/C', '유초등부', 0, '3', false);
INSERT INTO MEMBER (`id`, `email`, `password`, `name`, `asset`, `department_id`, `deleted`) values ('5', 'child', '$2a$10$qfKy2Md2U8ThUV0w/Om86uQBcvzqog3QAbCt0uhDpJ0olvPKXxn/C', '유아부', 0, '4', false);
